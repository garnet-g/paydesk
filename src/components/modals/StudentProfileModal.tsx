    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-950/40 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-2xl w-full max-w-2xl animate-in zoom-in-95 duration-300">
                <div className="p-6 border-b border-border dark:border-slate-800 flex justify-between items-start">
                    <div>
                        <h2 className="text-xl font-bold text-foreground dark:text-white">Student Profile</h2>
                        <p className="text-sm text-slate-500 mt-1">Complete student information and records</p>
                    </div>
                    <button
                        onClick={onClose}
                        className="p-2 hover:bg-muted dark:hover:bg-slate-800 rounded-full text-slate-500 transition-colors"
                    >
                        <X size={20} />
                    </button>
                </div>
                ...
                <div className="px-6 pt-4">
                    <div className="flex bg-muted dark:bg-slate-800 rounded-full p-1 border border-border dark:border-slate-700">
                ...
                <div className="p-6 max-h-[60vh] overflow-y-auto">
                    {activeTab === 'info' && (
                        <div className="grid grid-cols-2 gap-y-6 gap-x-8">
                            <div>
                                ...
                                <p className="font-bold text-foreground dark:text-white">{student.firstName} {student.middleName || ''} {student.lastName}</p>
                            </div>
                            <div>
                                <h4 className="text-xs font-semibold text-slate-500 mb-1">Admission Number</h4>
                                <p className="font-bold text-foreground dark:text-white">{student.admissionNumber}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p className="font-bold text-foreground dark:text-white capitalize">{student.gender || 'Unknown'}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p className="font-bold text-foreground dark:text-white">Not Set</p>
                            </div>
                            <div>
                                <h4 className="text-xs font-semibold text-slate-500 mb-1">Meal Plan</h4>
                                <p className="font-bold text-foreground dark:text-white">Default Plan</p>
                            </div>
                        </div>
                    )}
                    ...
                    {activeTab === 'academic' && (
                        <div className="space-y-6">
                            <div>
                                <h3 className="text-sm font-bold text-foreground dark:text-white mb-3">Recent Grades</h3>
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center p-4 border border-border dark:border-slate-800 rounded-2xl">
                                        <div>
                                            <p className="font-bold text-foreground dark:text-white">Mathematics</p>
                                    ...
                                    <div className="flex justify-between items-center p-4 border border-border dark:border-slate-800 rounded-2xl">
                                        <div>
                                            <p className="font-bold text-foreground dark:text-white">English</p>
                                            <p className="text-xs text-slate-500 mt-1">Term 1 2026</p>
                                        </div>
                                        <div className="text-right">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground dark:text-white mb-3">Attendance Statistics</h3>
                                <div className="bg-blue-50/50 dark:bg-blue-900/10 border border-blue-50 dark:border-blue-900/20 p-5 rounded-2xl flex justify-between items-center">
                                    ...
                                    <div className="text-right">
                                        <p className="text-lg font-black text-foreground dark:text-white">100.0%</p>
                    ...
                    {activeTab === 'billing' && (
                        <div>
                            <h3 className="text-sm font-bold text-foreground dark:text-white mb-3">Invoices</h3>
                            <div className="border border-border dark:border-slate-800 p-5 rounded-2xl hover:border-slate-300 dark:hover:border-slate-700 transition-colors">
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        <h4 className="font-bold text-foreground dark:text-white">Term 1 2026</h4>
                                ...
                                <div className="space-y-2 text-sm border-t border-border dark:border-slate-800 pt-4">
                                    <div className="flex justify-between">
                                        <span className="text-slate-500">Total Amount:</span>
                                        <span className="font-bold text-foreground dark:text-white">KES 59,000</span>
                                    </div>
                                    <div className="flex justify-between">
                    ...
                    {activeTab === 'parent' && (
                        <div>
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-sm font-bold text-foreground dark:text-white">Parent/Guardian Information</h3>
                                <button className="text-xs font-semibold px-3 py-1.5 border border-border dark:border-slate-700 rounded-lg flex items-center gap-1.5 hover:bg-muted dark:hover:bg-slate-800 transition-colors">
                                    <EditIcon /> Edit
                                </button>
                            </div>
                            ...
                            {guardian ? (
                                <div className="space-y-6">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <h4 className="text-xs font-semibold text-slate-500 mb-1">Full Name</h4>
                                            <p className="font-bold text-foreground dark:text-white">{guardian.firstName} {guardian.lastName}</p>
                                        </div>
                                        <div>
                                            <h4 className="text-xs font-semibold text-slate-500 mb-1">Relationship</h4>
                                            <p className="font-bold text-foreground dark:text-white">Guardian</p>
                                        </div>
                                    </div>

                                    <div className="space-y-4">
                                        <div className="flex gap-4 items-center">
                                            <div className="w-8 h-8 rounded-full bg-muted dark:bg-slate-800 flex items-center justify-center text-slate-400">
                                                <Mail size={16} />
                                            </div>
                                            <div>
                                                <h4 className="text-xs font-semibold text-slate-500 mb-0.5">Email</h4>
                                                <p className="font-bold text-foreground dark:text-white text-sm">{guardian.email || 'N/A'}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex gap-4 items-center">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-bold text-foreground dark:text-white text-sm">{guardian.phoneNumber || 'N/A'}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex gap-4 items-center">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-bold text-foreground dark:text-white text-sm">Nairobi, Kenya</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    return (
        <button
            ...
            className={`flex-1 py-1.5 px-4 rounded-full text-sm font-semibold transition-all shadow-none ${active
                    ? 'bg-white dark:bg-slate-950 text-foreground dark:text-white shadow-sm ring-1 ring-slate-200 dark:ring-slate-700'
